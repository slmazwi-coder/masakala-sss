    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-school-green text-[#FED219] px-4 py-2 rounded-xl font-medium hover:bg-school-dark transition-colors"
        >
        ...
        <div className="bg-gray-800 border border-gray-600 rounded-2xl p-6 mb-8">
          ...
          <div className="space-y-4">
            ...
            <button 
              onClick={save} 
              disabled={isScanning}
              className="flex items-center gap-2 bg-school-green text-[#FED219] px-6 py-2 rounded-xl font-medium hover:bg-school-dark disabled:opacity-50"
            >
              {isScanning ? (
