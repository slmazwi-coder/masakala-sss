        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3 text-gray-700">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Masakala A/A, Matatiele</p>
                    <p className="text-sm text-gray-500">Eastern Cape, 4730</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 text-gray-700">
            ...
            <div className="rounded-2xl p-6 border-2 border-amber-100 bg-amber-50">
              <h2 className="text-lg font-bold text-school-green mb-2">2027 Admissions</h2>
              <p className="text-sm text-gray-600 mb-4">Applications for 2027 are open from 20 April – 24 June 2026. Contact the school office or apply online.</p>
          ...
          <div className="rounded-2xl overflow-hidden shadow-lg border border-gray-100 min-h-[400px]">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3500!2d29.424!3d-30.548!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2sMatatiele%2C+Eastern+Cape!5e0!3m2!1sen!2sza!4v1"
