  ...
  return (
    <div className="py-12 sm:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="section-title">About Masakala SSS</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-stretch mb-16 sm:mb-24">
          ...
          >
            <div className="border-l-4 pl-5 mb-6" style={{ borderColor: '#FED219' }}>
          ...
          >
            {!campusFailed ? (
              ...
              <div className="w-full h-full bg-[#0D3B14] flex items-center justify-center">
                <div className="text-center text-[#FED219]/70 px-6">
                  <div className="mx-auto mb-3 w-12 h-12 rounded-xl bg-[#FED219]/10 flex items-center justify-center border border-[#FED219]/15">
                    <ImageIcon />
                  </div>
                  <div className="font-semibold">Campus image</div>
                  <div className="text-sm text-[#FED219]/60 font-mono">public/assets/about/</div>
                </div>
              </div>
            )}
          </motion.div>
        ...
        >
          <div className="text-center mb-10">
            ...
            <div className="w-16 h-1 mx-auto rounded-full" style={{ backgroundColor: '#FED219' }} />
          </div>

          <div className="bg-[#f5f5f0] rounded-3xl overflow-hidden shadow-lg border-2 border-[#FED219]">
            <div className="grid grid-cols-1 md:grid-cols-3">
              <div className="flex flex-col items-center justify-center bg-school-green p-8 md:p-10">
                <div className="w-40 h-40 md:w-48 md:h-48 rounded-full overflow-hidden border-4 border-[#FED219] shadow-xl mb-5">
                  <div className="w-full h-full flex items-center justify-center bg-[#0D3B14]">
                ...
                <h3 className="text-lg font-bold text-[#FED219] text-center leading-tight">School Principal</h3>
                <p className="text-sm font-semibold mt-1 text-center" style={{ color: '#FED219' }}>Principal</p>
                <div className="w-10 h-0.5 mt-4 rounded-full opacity-60" style={{ backgroundColor: '#FED219' }} />
              </div>

              <div className="col-span-2 flex flex-col justify-center p-8 md:p-12">
                <div className="text-6xl font-serif leading-none mb-2 opacity-40 select-none" style={{ color: '#FED219' }}>"</div>
                ...
                <div className="text-6xl font-serif leading-none mt-2 text-right opacity-40 select-none" style={{ color: '#FED219' }}>"</div>
              </div>
            </div>
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-white rounded-2xl p-6 text-center shadow border border-gray-100 border-b-4" style={{ borderBottomColor: '#0D3B14' }}>
