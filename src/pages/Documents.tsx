              ...
              {grades.map((grade) => (
                <button
                  ...
                  className={cn(
                    ...
                    selectedGrade === grade 
                      ? "bg-school-green text-[#FED219] shadow-lg" 
            ...
            filteredDocs.map((doc) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="p-3 bg-green-50 text-school-green rounded-xl group-hover:bg-school-green group-hover:text-[#FED219] transition-colors">
                    <FileText size={24} />
                  </div>
