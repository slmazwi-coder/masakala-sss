  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          {/* Header */}
          <div className="flex items-center justify-between px-4 py-3 bg-school-green text-[#FED219] shrink-0">
            <div className="flex items-center gap-2.5 min-w-0">
              <div className="w-9 h-9 rounded-full bg-[#FED219]/20 border border-[#FED219]/30 flex items-center justify-center shrink-0">
                <Sparkles size={16} />
              </div>
              <div className="min-w-0">
                <div className="font-bold text-sm leading-tight truncate">Masakala SSS Assistant</div>
                <div className="flex items-center gap-1 text-[11px] text-[#FED219]/70 mt-0.5">
            ...
            <div className="flex items-center gap-1 shrink-0">
              ...
              <div className="relative" ref={langMenuRef}>
                <button
                  ...
                  className="flex items-center gap-1 px-2 py-1 rounded-lg bg-[#FED219]/10 hover:bg-[#FED219]/20 transition-colors text-xs font-semibold"
                    ...
                    {(Object.entries(LANG_LABELS) as [SupportedLang, string][]).map(([code, label]) => (
                      <button
                        ...
                        className={`w-full text-left px-3 py-2 text-xs transition-colors ${
                          currentLang === code
                            ? 'bg-school-green text-[#FED219] font-bold'
              ...
              <button
                ...
                className="p-1.5 rounded-lg hover:bg-[#FED219]/10 transition-colors"
                ...
                <div className="flex flex-wrap gap-1.5 justify-center">
                  {QUICK_QUESTIONS.map((q) => (
                    <button
                      key={q}
                      onClick={() => send(q)}
                      className="text-[11px] px-2.5 py-1 rounded-full bg-white border border-school-green/25 text-school-green hover:bg-school-green hover:text-[#FED219] transition-colors font-medium shadow-sm"
                    >
                      {q}
                    </button>
                  ))}
          ...
          <div className="p-3 bg-white border-t border-gray-100 shrink-0">
            <div className="flex gap-2">
              ...
              <button
                ...
                className="bg-school-green hover:bg-school-green/90 text-[#FED219] px-3 py-2 rounded-xl transition-all disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center shrink-0"
      ...
      <button
        ...
        className="fixed z-50 bottom-4 right-3 sm:bottom-6 sm:right-6
          ...
          text-[#FED219] flex items-center justify-center
